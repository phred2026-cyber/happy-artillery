 ...
 * Values are read from {@link ConfigManager} — edit config/happy-artillery.json in-game to change them.
 * Vanilla / entity identifiers are not configurable.
 */
public class HAConstants {
    // ── Entity / item identifiers (not configurable) ────────────────────────
    ...
    // ── Display names (not configurable) ───────────────────────────────────
